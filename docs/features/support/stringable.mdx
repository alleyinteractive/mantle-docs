...
stringable( 'example' )->ltrim( string $characters = null );
```
...
stringable( 'example' )->rtrim( string $characters = null );
```
...
stringable( 'example' )->ucsplit(): Collection;
```
...
stringable( 'example' )->toString(): string;
```
...
stringable( 'example' )->jsonSerialize(): string;
```
...
stringable( 'example' )->offsetExists( mixed $offset ): bool;
```
...
stringable( 'example' )->offsetGet( mixed $offset ): string;
```
...
stringable( 'example' )->offsetSet( mixed $offset, mixed $value ): void;
```
...
stringable( 'example' )->offsetUnset( mixed $offset ): void;
```
...
stringable( 'example' )->__get( string $key );
```
...
stringable( 'example' )->__toString(): string;
```
